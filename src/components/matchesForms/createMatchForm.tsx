                ...
                <form onSubmit={handleSubmit} className="max-w-3xl mx-auto p-8 bg-white shadow-lg rounded-lg space-y-6">
                    ...
                    <div className="flex justify-start items-center px-2">
                        <label className="flex gap-2">
                            <input type="checkbox" name="mainEvent" checked={formData.mainEvent}
                    ...
                    {/* Submit Button */}
                    <button type="submit"
                            className="w-full bg-primary text-white py-3 rounded-md text-lg font-medium hover:bg-primary-dark">
                        Create Match
                    </button>
                </form>
            )}
