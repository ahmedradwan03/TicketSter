                    ...
                    >
                            ...
                            <div>
                                ...
                                <div className="mb-4">
                                    {formData.image ? (
                                        ...
                                        <div
                                            className="border-dashed border-2 p-6 text-center text-gray-500 rounded-lg">
                                ...
                                <CldUploadWidget
                                    uploadPreset="ticketster"
                                    onSuccess={(result) => handleImageUpload(result)}
                                    options={{ folder: 'ticketster/team' }}
                                >
                                    {({ open }) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                className="w-full p-3 bg-primary text-white rounded-lg hover:bg-primary-700 transition duration-300"
                                            >
                        ...
                        <div className="flex justify-around">
                            ...
                            <button
                                ...
                                className="p-3 bg-red-950 text-white font-semibold rounded-lg transition"
                            >
                                Delete Team
                            </button>
                        </div>
