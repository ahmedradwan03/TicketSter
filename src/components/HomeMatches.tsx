                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-8 w-[70%]">
                            {matches
                                ...
                                .map((match) => (
                                    <div
                                        key={match.id}
                                        className="bg-white p-6 rounded-lg shadow-lg hover:shadow-2xl transition-shadow transform hover:scale-105 border-l-4 border-indigo-500"
                                    >
                                        <div className="flex items-center justify-between mb-6">
                                            <Image
                                                ...
                                                width={60}
                                                height={60}
                                                className="object-contain rounded-full border-4 border-gray-300 shadow-md"
                                            />
                                        ...
                                        <div className="text-center mb-6">
                                            ...
                                            <p className="text-sm text-gray-600 mt-2">Price: From $185</p>
                                        </div>
